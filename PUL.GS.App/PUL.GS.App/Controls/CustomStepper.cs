...
namespace PUL.GS.App.Controls
{
    public class CustomStepper: StackLayout
    {
        ...
        {
            MinusBtn = new Button { Text = "-", FontAttributes = FontAttributes.Bold, FontSize = 14, HeightRequest = 30, WidthRequest= 32, TextColor = Color.FromHex("#e62025") };
            PlusBtn = new Button { Text = "+", FontAttributes = FontAttributes.Bold, FontSize = 14, HeightRequest = 30, WidthRequest = 32, TextColor = Color.FromHex("#e62025") };
