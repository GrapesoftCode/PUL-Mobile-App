...
namespace PUL.GS.App.ViewModels
{
    public class MasterViewModel : BaseViewModel
    {
        ...
        protected override void ViewIsAppearing(object sender, EventArgs e)
        {
            ...
            {
                    new MainPageMasterMenuItem { Id = 1, Title = "AJUSTES", Icon="profile.png",  TargetType = typeof(ProfilePage) },
                    new MainPageMasterMenuItem { Id = 2, Title = "PAGO", Icon="profile.png",  TargetType = typeof(ProfilePage) },
                    new MainPageMasterMenuItem { Id = 3, Title = "CUPONES", Icon="profile.png",  TargetType = typeof(ProfilePage) },
                    new MainPageMasterMenuItem { Id = 4, Title = "CENTRO DE AYUDA", Icon="profile.png",  TargetType = typeof(ProfilePage) },
                    new MainPageMasterMenuItem { Id = 5, Title = "NOTIFICACIONES", Icon="profile.png",  TargetType = typeof(ProfilePage) },
                    new MainPageMasterMenuItem { Id = 6, Title = "HISTORIAL", Icon="profile.png",  TargetType = typeof(ProfilePage) },
                    new MainPageMasterMenuItem { Id = 7, Title = "TÉRMINOS Y CONDICIONES", Icon="profile.png",  TargetType = typeof(ProfilePage) },
                };
