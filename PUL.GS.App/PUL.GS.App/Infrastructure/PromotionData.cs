...
namespace PUL.GS.App.Infrastructure
{
    public class PromotionData
    {
        ...
        public async Task<Response<Pager<Promotion>>> GetAll(int actualPage = 1, int recordsPerPage = 3)
        {
            ...
            try
            {
                ...
                var serviceResponse = await client.Consume(new Uri(settings.baseUrl),
                    $"{ServiceURIs.Promotion.GetRecordsPromotion}?actualPage={actualPage}&recorsPerPage={recordsPerPage}", HttpVerb.Get);
